...
export function Cascader({
    ...
    const displayValue =
        displayLabels.length > 0 ? (displayRender ? displayRender(displayLabels, selectedOptions) : displayLabels.join(" / ")) : null;
    ...
    const triggerElement = (
        <div
            ...
            className={cn(
                ...
                "h-10 px-4 py-2 w-50 cursor-pointer",
        ...
        >
            ...
            <div className="flex items-center gap-1 shrink-0">
                {allowClear && displayValue && !disabled && (
                    <X className="h-4 w-4 opacity-50 hover:opacity-100 cursor-pointer" onClick={handleClear} aria-label="Clear selection" />
                )}
    ...
    const columnsContent = (
        <div ref={scrollContainerRef} className={cn("flex", isMobile && "overflow-x-auto scrollbar-thin")} role="listbox" aria-label={placeholder}>
            {columns.map(
                (
                    column,
                    ...
                    <div
                        ...
                        className={cn(
                            "min-w-30 max-h-75 overflow-auto py-1 shrink-0",
                        ...
                        {column.map((option, itemIndex) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {hasChildren && <ChevronRight className="h-4 w-4 ml-2 shrink-0 opacity-50" aria-hidden="true" />}
                                </div>
                            );
                        })}
                    </div>
