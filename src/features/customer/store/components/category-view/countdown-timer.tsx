        ...
        <div className="flex gap-4 items-center justify-center">
            {timeUnits.map((unit) => (
                <div key={unit.label} className="flex flex-col items-center">
                    <div className="bg-secondary text-secondary-foreground rounded-md px-3 py-2 text-2xl md:text-3xl font-mono font-bold min-w-12 text-center flex justify-center items-center overflow-hidden">
                    ...
                    <span className="text-[10px] tracking-wider font-semibold text-muted-foreground mt-1">{unit.label}</span>
                </div>
            ))}
        </div>
    );
