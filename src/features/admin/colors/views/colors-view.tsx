...
export const ColorsView = ({ storeId }: ColorsViewProps) => {
    const router = useRouter();

    const { data: colors } = useSuspenseQuery(orpc.colors.getManyByStore.queryOptions({ input: { storeId } }));
    ...
    return (
        <>
            <div className="flex items-center justify-between">
                ...
                <Button onClick={() => router.push(`/admin/${storeId}/colors/new`)}>
