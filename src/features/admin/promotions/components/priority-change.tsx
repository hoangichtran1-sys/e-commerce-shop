...
import { PromotionMode } from "@/generated/prisma/enums";
...
export const PriorityChange = ({ id, storeId, initialData, mode }: PriorityChangeProps) => {
    const [priority, setPriority] = useState(initialData);
    const queryClient = useQueryClient();

    const change = useMutation(
        orpc.promotions.priorityChange.mutationOptions({
            onSuccess: () => {
