...
interface AttributeActionProps {
    id: string;
    storeId: string;
...
export const AttributeActions = ({
    ...
    const [RemoveConfirmation, confirmRemove] = useConfirm(
        "Are you sure?",
        "The following action will permanently remove this attribute",
    );

    const onCopy = () => {
        navigator.clipboard.writeText(id);
        toast.success("Attribute ID copied to the clipboard");
    };
        ...
        <div className="flex justify-end">
            ...
            <DropdownMenu modal={false}>
                ...
                <DropdownMenuContent align="end" className="w-48">
                    ...
                    <DropdownMenuItem
                        onClick={() =>
                            router.push(`/admin/${storeId}/attributes/${id}`)
                        }
                        className="font-medium p-2.5"
                    >
